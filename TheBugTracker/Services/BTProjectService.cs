...
namespace TheBugTracker.Services
{
    public class BTProjectService : IBTProjectService
    {
        ...
        {
            BTUser cuurentPM = await GetProjectManagerAsync(projectId);
            if(cuurentPM != null)
            {
                try
                {
            ...
            {
                Console.WriteLine($"******* Error ******* - Error Adding PM to project. --> {ex.Message}");
                return false;
            }
        ...
        public async Task ArchiveProjectAsync(Project project)
        {
            try
            {
                ...
                // Handle archive of tickets associated with the project
        ...
        public async Task<List<Project>> GetUserProjectsAsync(string userId)
        {
            ...
            {
                Console.WriteLine($"******* Error ******* - Error Getting User's projects. --> {ex.Message}");
                throw;
            }
        }
        ...
        {
            int prorityId = (await _context.ProjectPriorities.FirstOrDefaultAsync(p => p.Name == priorityName)).Id;
            return prorityId;
        }
